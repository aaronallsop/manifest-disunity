...
> **Decided in:** round 1 (secession), round 3 (politics)
...
|---|---|---|
| [[Rulings - Politics#Politics ruling 1]] | Ruling 1 — three axes, and the roster named for real parties. Recorded at P2 and in DECISIONS.md D185. Superseded in its roster by ruling 2. | **PARTLY superseded - read the note before using it** · ruled, not built |
| [[Rulings - Politics#Politics ruling 3]] | Ruling 3 — What a stateless society is, and what it costs to trade with one | still live · ruled, not built |
