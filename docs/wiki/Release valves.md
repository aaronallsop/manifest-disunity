...
<!-- WRITER: the in-world explanation. Raw material found: yes — the federal government declaring martial law in the counties around Washington to prevent a coup, and the painted Washington D.C. region the story needs already exists in the content. This is the page a player opens when a region is about to leave, and it is the round's answer to the Tuesday question. -->
...
| [[Rulings - Politics#Politics ruling 11a]] | Ruling 11a — The "remove the want" column belongs to the ADJECTIVE, and there are five of them | still live · ruled, not built |
