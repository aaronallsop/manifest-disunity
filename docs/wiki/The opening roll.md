...
<!-- WRITER: the in-world explanation. Raw material found: yes — Deseret half-born: the Wasatch Front always cedes, every other corridor Area rolls its own chance, and anything left disconnected from Salt Lake is remembered as left behind. Deseret opens unrecognised, with Utah's signature as the key that unlocks the continent. -->
