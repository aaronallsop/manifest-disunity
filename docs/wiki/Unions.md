...
<!-- WRITER: the in-world explanation. Raw material found: yes — seven governors signing the Farmers Union, and the open question of what it cost Illinois when Chicago walked out. Titled PLURAL on purpose, to keep it clear of 'the Union' that broke up. -->
...
| [[Rulings - Politics#Politics ruling 25]] | Ruling 25 — A federation is a real form, not a name: many states, a flat internal toll, an elected leader and a turn of its own | still live · ruled, not built |
| [[Rulings - Politics#Politics ruling 30]] | Ruling 30 — Inside a federation you are at peace with every member. Full stop | still live · ruled, not built |
