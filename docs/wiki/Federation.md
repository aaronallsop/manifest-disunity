...
<!-- WRITER: the in-world explanation. Raw material found: yes — the United States of New England, six former states under one flag, and Aaron's Gulf Compact aside on Acadiana. Carries one open finding a writer must mark as a question, not a rule: the federation's deterrent may be absolute, and only the alpha will tell. -->
