...
| [[Rulings - Secession#Secession ruling 36]] | the source is RAND, pulled once and baked, never fetched at runtime. | **PARTLY superseded - read the note before using it** · ruled, not built |
