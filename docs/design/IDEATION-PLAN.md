...
| **3** ◀ **OPEN, PART-WAY THROUGH — 14 rulings as of 11 September 2026.** Answered: the one table of what a government can do about each verb, what a stateless society is, the civil war clock, how movements grow on ungoverned ground, and martial law. **Still open: seven spine questions, plus two things that are Aaron's and have never been carded — the Farmers Union's verb, and who takes an Area when the total movement share crosses 40% but no single movement does.** Neither the closing test nor scenario 3 has been traced. See the status block at the head of `politics-ideation.md` | **Politics** | Owns two more pressures, and owns all four ways a government can answer a movement — give ground, give self-rule, change what you stand for, or send soldiers. **Round 2 handed it two things: the mutable movement verb (ruling 30, C120) — the one piece of machinery this design asks for that does not exist — and the government's answer to Expand and Reconquer beside the four release valves, as one table rather than two** |
...
`politics-ideation.md` (**open**), `economy-ideation.md` (84 entries, parked), `diplomacy-ideation.md`,
